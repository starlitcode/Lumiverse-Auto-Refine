        ...
        try {
            ...
            if (wantBar) {
                ...
                if (bar) {
                    ...
                    if (holding && !part)
                        bar.appendChild(slotButton("bar-part", "Refine the part I selected", () => refinePicked(), partIcon));
                    if (holding && !snip)
                        bar.appendChild(slotButton("bar-snip", "Take out what I selected", () => snipPicked(), snipIcon));
                    if (!holding) {
                        try {
                            if (part)
                                part.remove();
