...
const BASE_RULES = 'You are editing one message from an ongoing roleplay. Rewrite it so it ' +
...
// ---- running one refine ----
async function askModel(text, isUser) {
    ...
    try {
        const req = { messages: buildPrompt(text, isUser) };
