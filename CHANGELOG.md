...
- **More phrases to cut** in The judge, under **Instant Penalties**: eyes that sparkle with mischief, ministrations, a testament to something, and a question asked in the narration and answered at once. Truly and utterly join **Dead Weight**.
...
- **The four built-in prompts have new names.** The line edit is now **The judge**, and The copy edit is now **The line judge**. The versions for a model that thinks are renamed the same way. A prompt you had picked, or named as a pass, follows the new name.
