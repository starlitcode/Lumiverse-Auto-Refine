// The version is written in three places and shown to people from two of them:
// Lumiverse reads spindle.json, and the problem report and the Log print the
// constant in the frontend. A release that bumps two of the three ships a
// report claiming the wrong version, which is the one thing a problem report
// exists to get right.
