...
- **When a refine lands** is how you find out: a pop-up, a sound, or neither. With nothing chosen the sound is a short built-in blip, synthesised in the browser, with no file to ship. Attach your own or paste a link to replace it.
